...
import dev.marlonlom.mocca.calculator.util.UsedNumbers.FIFTY_THOUSAND
...
import dev.marlonlom.mocca.calculator.util.UsedNumbers.ONE_HUNDRED
import dev.marlonlom.mocca.calculator.util.UsedNumbers.ONE_HUNDRED_FIFTY_THOUSAND
import dev.marlonlom.mocca.calculator.util.UsedNumbers.ONE_HUNDRED_THOUSAND
...
import dev.marlonlom.mocca.calculator.util.UsedNumbers.TWO_HUNDRED_THOUSAND
import dev.marlonlom.mocca.calculator.util.UsedNumbers.ZERO
import dev.marlonlom.mocca.calculator.util.UsedNumbers.multiplyOrderValueByFour
